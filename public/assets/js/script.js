(function ($) {
    ...
    if ($(".site-header li.dropdown ul").length) {
        $(".site-header li.dropdown").append(
    ...
    if (
        ...
        $sync2
            .owlCarousel({
                ...
                nav: true,
                navText: [
                    '<span class="icon flaticon-arrows-8"></span>',
    ...
    //     var $activeBtn = $(".prod-tabs .tab-btn.active-btn").first();
    //     var target = $($activeBtn.attr("href"));

    //     $(".prod-tabs .tab").hide().removeClass("active-tab");
    //     target.show().addClass("active-tab").css("opacity", 1);
    // });
    if ($(".prod-tabs .tab-btn").length) {
        $(".prod-tabs .tab-btn").on("click", function (e) {
            e.preventDefault();
            ...
            target.show().css("opacity", 1).addClass("active-tab");
        });
    }
